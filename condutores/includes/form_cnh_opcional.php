    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            <div class="col-md-3">
                ...
                <input class="form-control" id="cnh_numero" name="cnh_numero" inputmode="numeric" pattern="[0-9]*" maxlength="12" value="<?= esc($valorCnh('numcnh')) ?>">
            </div>
            <div class="col-md-2">
                <label class="form-label" for="cnh_validade">Validade</label>
                <input class="form-control" type="date" id="cnh_validade" name="cnh_validade" value="<?= esc(formatarDataPortal($valorCnh('validade'), 'Y-m-d')) ?>">
            </div>
            <div class="col-md-2">
                <label class="form-label" for="cnh_uf">UF de emissão</label>
                <select class="form-select" id="cnh_uf" name="cnh_uf">
            ...
            <div class="col-md-2">
                ...
                <input class="form-control text-uppercase" id="cnh_categoria" name="cnh_categoria" maxlength="5" value="<?= esc($valorCnh('categoria')) ?>">
            </div>
            <div class="col-md-1">
