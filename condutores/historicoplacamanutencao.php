...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <p class="text-muted mb-0">Consulta da placa adaptada para as tabelas próprias do portal AutoFrotas.</p>
        </div>
    ...
    <?php else: ?>
        ...
        <div class="d-flex flex-wrap gap-2">
            <?php if ($matriculaCondutor !== ''): ?>
                ...
                <a class="btn btn-secondary" href="historico-placas-condutor.php?matcond=<?= urlencode($matriculaCondutor) ?>">Histórico de Condutores</a>
                <a class="btn btn-info" href="dados-condutor.php?matcond=<?= urlencode($matriculaCondutor) ?>">Dados do Condutor</a>
            <?php else: ?>
                <button class="btn btn-success" type="button" disabled>Histórico de Vistorias</button>
                <button class="btn btn-secondary" type="button" disabled>Histórico de Condutores</button>
                <button class="btn btn-info" type="button" disabled>Dados do Condutor</button>
            <?php endif; ?>
            <form action="../historicoplacamanutencao.php" method="post"><input type="hidden" name="placa" value="<?= esc($placa) ?>"><button class="btn btn-primary">Histórico de Manutenções</button></form>
        </div>
    <?php endif; ?>
</div>
