    ...
    <form method="post" action="control/processarcondutor.php" class="card" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4"><label class="form-label" for="ccusto">Centro de custo</label><select class="form-select" name="ccusto" id="ccusto"><option value="">Selecione</option><?php $valorCcustoAtual = valorCondutorPj($condutor, 'ccusto'); foreach ($ccustos['linhas'] as $linha): $valorCcusto = valorCentroCustoPj($linha); if ($valorCcusto !== ''): ?><option value="<?= esc($valorCcusto) ?>" <?= $valorCcustoAtual === $valorCcusto ? 'selected' : '' ?>><?= esc($valorCcusto) ?></option><?php endif; endforeach; ?></select></div>
