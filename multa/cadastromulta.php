...
$colaboradores = carregarOpcoes(
    $conn,
    'SELECT matricula, nome FROM bdaniel.tbfuncionario WHERE status = "Ativo" ORDER BY nome',
    'matricula',
    'nome'
);
...
$filiais = carregarOpcoes(
    $conn,
    'SELECT idtbfilial, descricao AS nome FROM BdPonto.tbfilial ORDER BY descricao',
    'idtbfilial',
    'nome'
);
