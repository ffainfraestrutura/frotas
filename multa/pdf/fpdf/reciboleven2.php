...
$sql2a = "SELECT MAX(idtbfuncionario) AS idtbfuncionario FROM tbfuncionario WHERE nome = '$nome'; ";
...
$sql6 = "SELECT tel_corp FROM tbfuncionario WHERE matricula='$matricula'; ";
