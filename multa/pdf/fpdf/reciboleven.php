...
function Header()
	{
		// Logo
		$this->Image('../../src/images/logo-leven.png',80,5,45,15);
		...
		$this->Cell(35);
		// Título
		$this->MultiCell(0,14.8, utf8_decode('FORMULÁRIO DE IDENTIFICAÇÃO DO CONDUTOR INFRATOR'),0,1,'c','false');
		// Line break (quebra de linha)
		//$this->Ln(2);
	}
...
$pdf->Cell(0.1);
$pdf->Cell(40,6,utf8_decode("$numcnh"),1, 'J', false);
$pdf->Cell(0.1);
...
$pdf->Ln(12);
$pdf->Cell(10);
$pdf->MultiCell(70,6,utf8_decode("______________________________\nAssinatura do Condutor/Infrator"),0, 'J', false);
$pdf->Ln(-12);
$pdf->Cell(90);
$pdf->MultiCell(90,6,utf8_decode("______________________________\nAssinatura do Proprietário do Veículo"),0, 'J', false);
