...
$this->SetXY(10, 20);
     $this->Image('logobluephone.JPG',1,1,50);
     ...
     $this->Cell(75, 5, 'Taxa de Resposta ao Usuário - Periodicidade Trimestral');
	 $this->SetFont('Helvetica', 'I', 14);
	 $this->ln();
	$this->ln();
	$this->Cell(0, 5, ' Emitido em: '.$data.' ', 0, 0, 'R');
	...
	$this->Cell(30, 5, 'Período de: '.$datainicio.' até: '.$datafim .'', 0, 0, 'L');
...
$this->Line(10, 270, 200, 270);
      $this->Cell(0,10,'Página '.$this->PageNo().' de {total}',0,0,'R');
   }
