...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3"><div><h1 class="h3 mb-1">Histórico de Manutenção</h1><p class="text-muted mb-0">Placa: <?= esc($placa) ?></p></div><a class="btn btn-secondary" href="/autofrota/veiculos/dadosplaca.php<?= $placa !== '' ? '?' . http_build_query(['placa' => $placa]) : '' ?>">Voltar</a></div>
