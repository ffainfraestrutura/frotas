...
<div class="container-fluid px-4" style="width: 100%;">
    ...
    <div class="form-actions-floating d-flex gap-2" role="group" aria-label="Ações do cadastro">
        ...
        <?php endif; ?>
        <a class="btn btn-secondary" href="solicitar-manutencao-preventiva.php" onclick="if (window.history.length > 1) { window.history.back(); } else { window.location.href='solicitar-manutencao-preventiva.php'; } return false;"><i class="fa-solid fa-arrow-left me-1" aria-hidden="true">Voltar</a>
